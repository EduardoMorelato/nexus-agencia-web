...
Ler `templates/skills/catalogo.md` pra ver se alguma das tarefas mencionadas já é coberta por uma skill nativa do Antigravity IDE ou validada pelo MazyOS. Se sim, sugerir a skill existente em vez de criar uma nova:
