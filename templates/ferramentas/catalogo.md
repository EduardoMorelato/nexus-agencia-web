...
Referencia de APIs, CLIs e conectores que podem ser usados dentro de skills do Antigravity IDE.
...
### Post for Me API
**O que faz:** Publica posts no Instagram e TikTok direto do Antigravity IDE
...
**Precisa de conta:** Nao, ja vem no Antigravity IDE
...
MCPs sao conectores que dao acesso direto a plataformas dentro do Antigravity IDE.
...
### Gmail
**O que faz:** Le e compoe emails sem sair do Antigravity IDE
