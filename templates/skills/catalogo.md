...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/frontend-design`
**Fonte:** Skill nativa do Antigravity IDE
...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/canvas-design`
**Fonte:** Skill nativa do Antigravity IDE
...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/pdf`
**Fonte:** Skill nativa do Antigravity IDE
...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/docx`
**Fonte:** Skill nativa do Antigravity IDE
...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/pptx`
**Fonte:** Skill nativa do Antigravity IDE
...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/xlsx`
**Fonte:** Skill nativa do Antigravity IDE
...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/doc-coauthoring`
**Fonte:** Skill nativa do Antigravity IDE
...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/webapp-testing`
**Fonte:** Skill nativa do Antigravity IDE
...
**Como instalar:** Ja vem nativo no Antigravity IDE. Chamar com `/skill-creator`
**Fonte:** Skill nativa do Antigravity IDE
